...
class BLEval(object):
    ...
    def computeTopology(self):
        ...
        for dataset in tqdm(self.input_settings.datasets,
                            total = len(self.input_settings.datasets), unit = " Datasets"):
            CCDict[dataset["name"]], GEFFDict[dataset["name"]], LEFFDict[dataset["name"]], NCDict[dataset["name"]], SPDict[dataset["name"]], ASSDict[dataset["name"]], DSDict[dataset["name"]], CTDict[dataset["name"]], = Topologies(dataset, self.input_settings)
        ...
        return CC, GEFF, LEFF, NC, SP, ASS, DS, CT
