...
class BLEval(object):
    ...
    def computeHubs(self):
        ...
        for dataset in tqdm(self.input_settings.datasets,
                            total = len(self.input_settings.datasets), unit = " Datasets"):
            PRict[dataset["name"]], ICDict[dataset["name"]], OCDict[dataset["name"]], EIGDict[dataset["name"]], BTDict[dataset["name"]], RDDict[dataset["name"]] = Hubs(dataset, self.input_settings)
